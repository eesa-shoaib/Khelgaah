...
The project is divided into three 2-week iterations, each focusing on a working vertical slice of the platform.

| Iteration | Focus | Key Deliverable |
| ------ | ------ | ------ |
| Iteration 1 | Discovery Engine | MVP with Map integration and Venue search. |
| Iteration 2 | Booking & SaaS | Transactional booking system and Owner dashboards. |
| Iteration 3 | Community | Tournament management and social matchmaking. |
